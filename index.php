        ...
        <div class="coming-soon">
            <div class="inner-bg">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <h2>EIS AQUI A SERVA DO SENHOR. FAÇA-SE EM MIM SEGUNDO TUA PALAVRA12</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 subscribe">
                    <h3>Cadastre-se e faça parte</h3>
                    <p>Inscreva-se para receber todas as notícias</p>                    
                    <form class="form-inline">
                    	<button class="btn" onclick="window.open('formularios/inscricao.php','_self')">Inscrever-se</button>
                    </form>
