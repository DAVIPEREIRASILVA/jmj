...
jQuery.fn.calendario = function(options){
	...
	this.each(function(){
		...
		//criando div
		jQuery('body').append('<div class="calendario" id="'+idCalendario+'"><a href="#" class="fechar" title="Fechar"><img src="../../Template/images/close-button-hi.png" width="18px" /></a><a href="#" class="bt_controle_mes bt_voltar_mes"><img src="../../Template/images/back-button-hi.png" width="15px" /></a><p class="nome_mes">mês ano</p><a href="#" class="bt_controle_mes bt_avancar_mes"><img src="../../Template/images/foward-button-hi.png" width="15px" /></a><ul class="lista_dia"><li class="semana">D</li><li class="semana">S</li><li class="semana">T</li><li class="semana">Q</li><li class="semana">Q</li><li class="semana">S</li><li class="semana">S</li></ul></div>');
