...
(/** @lends <global> */function( $ ) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = '<table align="center"><tr><td><label>'+sSearchStr+'</label></td></tr></table>';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			nLength.innerHTML = '<label style="display:none">'+oSettings.oLanguage.sLengthMenu.replace( '_MENU_', sStdMenu )+'</label>';
